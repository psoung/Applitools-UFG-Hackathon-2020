...
public class HomePage {
    ...
    private String viewBar = "LI____200";

    private String filterIcon = "ti-filter";
    private String filterText = "SPAN____208";
    private String toolTips = "UL____222";

    private String bottomMenu_Columns = "DIV__row__419";

    private String emailBar = "DIV__formgroup__450";

    private String blackShoe1 = "IMG__imgfluid__215";
    private String blackShoe2 = "IMG__imgfluid__239";
